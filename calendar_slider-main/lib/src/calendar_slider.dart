...
class CalendarSliderState extends State<CalendarSlider>
  ...
  formattedDate({required String dateStr}) {
    // Step 2: Parse the ISO timestamp into a DateTime object
    DateTime parsedDate = DateTime.parse(dateStr);

    // Step 3: Format the DateTime object to the desired format
    String formattedDate = DateFormat('MMM dd, yyyy').format(parsedDate);

    return formattedDate; // Output: Sep 25, 2024
  }
      ...
      return Container(
        ...
        child: ScrollablePositionedList.builder(
            ...
            itemBuilder: (context, index) {
              ...
              bool isDisabled = widget.disabledTo != null
                  ? (date.isBefore(widget.disabledTo!))
                  : false;
              isDisabled = !isDisabled && widget.disabledFrom != null
                  ? (date.isAfter(widget.disabledFrom!))
                  : isDisabled;
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  color: widget.monthYearButtonBackgroundColor,
                                ),
                                child: Text(
                                  formattedDate(
                                      dateStr: widget.initialDate.toString()),
      ...
      builder: (BuildContext context) {
        ...
        return SizedBox(
          height: widget.fullCalendarScroll == FullCalendarScroll.vertical
              ? height
              : (MediaQuery.of(context).size.height / 7) * 3.7,
          child: Column(
