import 'package:aero_lounge/features/root/logbook/upcoming_flights/components/flight_check_out_form.dart';
...
class _FlightCheckOutScreenState extends State<FlightCheckOutScreen> {
  final flightCheckOutFormKey = GlobalKey<FormBuilderState>();
            ...
            child: SizedBox(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    FlightCheckOutForm(
                        flightCheckOutFormKey: flightCheckOutFormKey),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          flightCheckOutFormKey.currentState?.save();
                          if (flightCheckOutFormKey.currentState!.validate()) {}
                        },
