...
class FlightCheckInForm extends StatelessWidget {
  const FlightCheckInForm({
    super.key,
    required this.flightCheckInFormKey,
  });

  final GlobalKey<FormBuilderState> flightCheckInFormKey;

  @override
  Widget build(BuildContext context) {
    return FormBuilder(
      key: flightCheckInFormKey,
      child: Column(
        ...
        children: [
          ...
          DataFieldWidget(
            name: 'hobbs_in',
            label: 'Hobbs in',
            hintText: 'Enter Hobbs in',
            mandatory: true,
            suffixIcon: Icon(Icons.access_time),
            keyboardType: TextInputType.number,
            textInputAction: TextInputAction.next,
            validator: FormBuilderValidators.compose([
              FormBuilderValidators.required(errorText: 'Hobbs in is required'),
            ]),
          ),
          ...
          DataFieldWidget(
            ...
            validator: FormBuilderValidators.compose([
              FormBuilderValidators.required(
                  errorText: 'Tach 1 in is required'),
            ]),
          ),
          SpacerHelper.verticalSpaceMedium(),
          Row(
